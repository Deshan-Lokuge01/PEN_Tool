...
PROGMEM const char text1_6[] = "ESP32 PENTool";
PROGMEM const char text1_7[] = "WiFi Options";
...
PROGMEM const char text1_19[] = "Bluetooth Options";
...
PROGMEM const char text1_30[] = "Restart";
PROGMEM const char text1_31[] = "Sniffing";
PROGMEM const char text1_32[] = "Attacks";
PROGMEM const char text1_33[] = "General Features";
...
PROGMEM const char text1_44[] = "De-auth Sniff";
...
PROGMEM const char text1_49[] = "Scan & Save APs List";
...
PROGMEM const char text4_20[] = "Penetration Testing Tool";      //From 20 to 35 add spaces so : is in line like it is now
PROGMEM const char text4_21[] = "Wi-fi and Bluetooth ";
