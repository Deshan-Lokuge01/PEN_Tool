...
const String PROGMEM version_number = PENETRATION_VERSION;
...
void setup()
{
  ...
  #ifdef HAS_SCREEN
    #ifndef PENETRATION_MINI
      display_obj.drawJpeg("/pentest.jpg", 0 , 0);     // 240 x 320 image
    #else
      display_obj.drawJpeg("/pentest.jpg", 0, 0);
    #endif
  #endif
  ...
  backlightOn(); // Need this
    ...
    display_obj.tft.println("PENETRATION " + display_obj.version_number + "\n");
